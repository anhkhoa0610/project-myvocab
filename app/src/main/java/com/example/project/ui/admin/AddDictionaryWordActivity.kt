...
class AddDictionaryWordActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_dictionary_word)

        setHeaderTitle("Add Dictionary Word")
    ...
    private fun setEvent() {
        btnSave.setOnClickListener {
            ...
            val result = dictionaryWordDAO.addWord(newWord)
            ...
            if (result > -1) {
                ...
                Toast.makeText(this, "Error adding word!", Toast.LENGTH_SHORT).show()
            }
        }
